...
export const defaultTheme: Theme = {
  ...
  colors: {
    ...
    editorFocusBackground: 'rgba(0, 185, 107, 0.02)',
    editorBorder: '#e2e8f0',
    editorFocusBorder: '#00b96b',
    ...
    blockquoteBorder: '#00b96b',
    blockquoteText: '#475569',
    linkColor: '#00b96b',
    linkHoverColor: '#009957',
    selectionBackground: 'rgba(0, 185, 107, 0.2)',
    caretColor: '#00b96b'
  },
  fonts: {
  ...
  shadows: {
    ...
    editorFocusShadow: '0 0 8px rgba(0, 185, 107, 0.3)',
...
export const darkTheme: Theme = {
  ...
  colors: {
    ...
    editorFocusBackground: 'rgba(0, 185, 107, 0.05)',
    editorBorder: '#4a5568',
    editorFocusBorder: '#3cc884',
    ...
    blockquoteBorder: '#3cc884',
    blockquoteText: '#cbd5e0',
    linkColor: '#3cc884',
    linkHoverColor: '#3cc884',
  ...
  shadows: {
    ...
    editorFocusShadow: '0 0 8px rgba(0, 185, 107, 0.4)',
