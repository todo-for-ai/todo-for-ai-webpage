...
export class AgentsApi {
  ...
  async createAgent(workspaceId: number, data: CreateWorkspaceAgentRequest) {
  ...
  async updateAgent(workspaceId: number, agentId: number, data: UpdateWorkspaceAgentRequest) {
